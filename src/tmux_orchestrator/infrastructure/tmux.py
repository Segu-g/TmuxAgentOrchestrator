...
Infrastructure adapter for the tmux external system.
This module is the canonical home for TmuxInterface; the old path
``tmux_orchestrator.tmux_interface`` re-exports from here (Strangler Fig shim).
...
References:
    - Cockburn, Alistair. "Hexagonal Architecture Explained" (2024)
      Output adapter: wraps an external system (tmux) behind a stable interface.
