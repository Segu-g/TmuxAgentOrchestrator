...
Canonical location: tmux_orchestrator.application.registry
...
The root-level shim ``registry.py`` re-exports everything from here for
backward compat.

References:
- Evans "Domain-Driven Design" (2003) Ch. 6 — Aggregates
- DESIGN.md §10.3 (2026-03-05), §10.56 (v1.1.24 — Clean Architecture Phase 2)
"""
...
from tmux_orchestrator.application.circuit_breaker import CircuitBreaker
...
class AgentRegistry:
    ...
    def __init__(
        ...
        *,
        ...
        self._agents: dict[str, Any] = {}  # Agent objects (duck-typed, no import needed)
    ...
    def register(self, agent: Any, *, parent_id: str | None = None) -> None:
    ...
    def get_director(self) -> Any | None:
